...
async def gap_fill(
    ...
    try:
        ...
        # NOTE: No warmup here. The sync script already calls
        # /api/v1/refresh-connections after each cycle, which lazily
        # reconnects the read-only singleton. Eager warmup on a 440GB DB
        # caused OOM in the 1GB container.
